...
public class ConfigureWidgetActivity extends CitrBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getPreferenceDefaultNull(SessionHelper.KEY_USERNAME) == null
                || preferences.getPreferenceDefaultNull(SessionHelper.KEY_PASSWORD) == null) {
            ...
            if (!resp.isSuccessfull() || groupsMemberOf.isEmpty()) {
                Toast.makeText(getApplicationContext(), resp.getDisplayMessage(), Toast.LENGTH_LONG).show();
            }
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> aParent, View aView, int aPos, long anId) {
                    ...
                    CitrWidgetProvider.updateAppWidget(context, appWidgetManager, widgetId);
