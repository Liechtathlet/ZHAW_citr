...
public class MainActivity extends CitrBaseActivity {
	...
	final GroupAdapter adapterOwn = new GroupAdapter(this,
		groupsOwn.getResponseObject());
	...
	final SubscriptionAdapter adapterMemberOf = new SubscriptionAdapter(
		this, groupsMemberOf.getResponseObject());
