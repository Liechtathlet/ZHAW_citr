...
public class ClientGroupServicesImpl extends AbstractClientRBaseServiceImpl implements GroupServices {
     ...
     * (non-Javadoc)
     *
     * @see ch.zhaw.mdp.lhb.citr.rest.IRGroupServices#getGroupSubscriptionRequests()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch.zhaw.mdp.lhb.citr.rest.IRGroupServices#getUserGroups()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch.zhaw.mdp.lhb.citr.rest.IRGroupServices#acceptSubscription()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch.zhaw.mdp.lhb.citr.rest.IRGroupServices#declineSubscription()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch.zhaw.mdp.lhb.citr.rest.IRGroupServices#getMessages()
     */
    @Override
