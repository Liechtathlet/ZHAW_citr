...
CREATE SCHEMA IF NOT EXISTS `@db.schema@` DEFAULT CHARACTER SET utf8 ;
USE `@db.schema@` ;

-- -----------------------------------------------------
-- Table `@db.schema@`.`tbl_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `@db.schema@`.`tbl_user` ;
...
-- -----------------------------------------------------
-- Table `@db.schema@`.`tbl_citation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `@db.schema@`.`tbl_citation` ;
...
-- -----------------------------------------------------
-- Table `@db.schema@`.`tbl_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `@db.schema@`.`tbl_group` ;
...
-- -----------------------------------------------------
-- Table `@db.schema@`.`tbl_subscription`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `@db.schema@`.`tbl_subscription` ;
...
INSERT INTO `@db.schema@`.`tbl_user`
